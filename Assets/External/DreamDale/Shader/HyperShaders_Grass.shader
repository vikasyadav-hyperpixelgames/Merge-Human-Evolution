Shader "HyperShaders/Grass" {
	Properties {
		...
		_GrassDownForce ("Grass DownForce", Float) = 1
		_GrassNoiseSpeed ("Grass Noise Speed", Float) = 0.01
		_GrassNoiseValue ("Grass Value", Float) = 0.3
		_MaxHeight ("Max Height", Float) = 2.1
		_GrassHeight ("Grass Height", Float) = 2.1
		[Toggle(SF_GRAIN_GRASS)] _SF_GRAIN_GRASS ("Grain Grass", Float) = 0
		_GrainPushPower ("Grain Push Power", Float) = 0.5
	}
